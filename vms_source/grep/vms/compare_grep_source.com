...
$!
$! By default:
$!    The source directory is source_root:[grep.reference.grep],
$!    the logical used on my system for the GNV Mecurial repository checkout.
$!    If source_root: is not defined, then src_root:[grep] will be
$!    translated to something like DISK:[dir.grep.reference.grep]
$!    and then DISK:[dir.grep.vms_source.grep] will be used.
$!
$!    The copy directory is vms_root:[grep]
...
$!     The source directory tree is: src_root:[grep]
$!     The copy directory is src_root1:[grep]
$!
$!   src_root1:[grep] is used by me to work around that VMS backup will
...
$!    The source directory is vms_root:[grep]
$!    The copy directory is vms_root1:[grep]
$!
$!   vms_root:
$!   src_root1:[grep] is used by me to work around that VMS backup will
$!   not use NFS as a source directory so I need to make a copy.
...
$   if update_file
$   then
$       if f$search("src_root1:[000000]grep.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed src_root1:[grep]
$       endif
$   endif
$endif
$!
...
$   if update_file
$   then
$       if f$search("vms_root1:[000000]grep.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed vms_root1:[grep]
$       endif
$   endif
$endif
$!
