...
$!   Add file lines for grep.
$!   Add Link alias procedure file (used for grep)
$!   Add [.SYS$STARTUP]grep_startup file
$!   Add Release notes file.
$!
$! The file pcsi_grep_file_list.txt is read in to get the files other
...
$! link [usr.bin]grep. for [usr.bin]grep.exe.
$!
...
$!      1. Duplicate filenames need an alias procedure.
$!      2. ODS-5 filenames need an alias procedure.
$!      3. Special alias links for executables (grep. -> gnv$grep.exe)
$!         if a lot, then an alias procedure is needed.
$!      4. Rename the files to lowercase.
$!
$!
...
$!---------------------------------------------------------------------
$ open/read flst [.vms]pcsi_grep_file_list.txt
$!
$inst_alias_loop:
...
$! remove aliases
$   line_out = -
       "  ""@pcsi$destination:[gnv.vms_bin]grep_alias_setup.com remove"""
$   i = 0
$ex_rem_loop:
...
$       write pdsc line_out
$   endif
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]remove_old_grep.com"","
$   write pdsc line_out
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]grep_alias_setup.com"""
$   i = 0
$ex_pins_loop:
$       line = f$element(i, ",", add_alias_lines)
$       i = i + 1
...
$ write pdsc "     source [vms_bin]gnv$grep_startup.com ;"
$!
$!   Add Release notes file.
$!------------------------------
$ write pdsc -
